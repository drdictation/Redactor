...
export const ROUTE_CONFIG: Record<string, RouteConfig> = {
    '/': {
        ...
        h1: 'Redact PDFs Securely in Your Browser.',
        securityHero: 'Black out sensitive text and export a flattened PDF locally.',
        subhead: 'Upload a PDF, draw redactions, and download a share-safe copy. We also scan for hidden leaks before export so you can redact with confidence.',
        items: [
            { title: 'Easy Redaction Workspace', text: 'Upload your PDF, draw black boxes over sensitive content, and prepare a clean outbound copy.' },
            { title: 'Flattened Export', text: 'Every exported page is flattened into an image-based PDF so covered text cannot be casually recovered.' },
            { title: 'Built-In Leak Check', text: 'We scan for hidden text and metadata leaks before you share the finished file.' },
        ],
        howThisWorks: 'Upload your PDF, add redactions, review any hidden leak warnings, and export a flattened copy that is safer to share.',
        trustSignals: '100% Client-Side • Flattened Export • Hidden Leak Check',
        ctaText: 'Upload PDF to Redact',
        metaTitle: 'ReactPDF | Redact PDFs Securely in Your Browser',
        metaDescription: 'Redact PDFs securely in your browser, export a flattened copy, and scan for hidden text or metadata leaks before sharing. 100% private and client-side.',
    },
